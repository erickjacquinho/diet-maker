...
- [ ] T001 [P] Criar/estender fixture e helper de banco em
...
- [ ] T002 [P] Escrever testes puros de avaliação e acompanhamento em
...
- [ ] T003 Implementar tipos, validação e invariantes em
...
- [ ] T004 [P] Escrever testes de migration em
  ...
  NFR-006).
- [ ] T005 Implementar `body_assessments` e `next_follow_ups` no schema e uma
...
- [ ] T006 [P] Escrever integração do repositório em
  ...
  SC-002).
- [ ] T007 Implementar a porta única `ClinicalRepository` em
...
- [ ] T008 [P] Escrever testes da fachada e dos read models clínicos em
...
- [ ] T009 Estender o `PatientApplication`, o `PatientProfileReader` e a
...
- [ ] T010 [P] Escrever/ajustar testes de `useAssessmentWorkspacePage` e da
...
- [ ] T011 Refatorar `src/hooks/useAssessmentWorkspacePage.ts` e a rota
...
- [ ] T012 [P] Escrever testes de edição do modal e do perfil em
...
- [ ] T013 Atualizar `src/hooks/usePatientProfilePage.ts`,
...
- [ ] T014 [P] Escrever testes do acompanhamento em
  ...
  NFR-005, SC-003).
- [ ] T015 Adaptar `src/components/molecules/NextEventModal.tsx` e
...
- [ ] T016 [P] Escrever testes de perfil, lista, atividade e consulta em
...
- [ ] T017 Implementar as projeções no `PatientProfileReader` e na aplicação,
...
- [ ] T018 [P] Estender `tests/architecture/patient-persistence-boundary.test.ts`
...
- [ ] T019 Remover os consumidores clínicos legados de
...
- [ ] T020 [P] Executar/ajustar testes de estados e acessibilidade existentes
  ...
  NFR-005, SC-006).
- [ ] T021 [P] Criar `tests/performance/clinical-profile.perf.test.ts` com
...
- [ ] T022 [P] Criar `tests/browser/clinical-persistence.spec.ts` em uma única
  ...
  SC-008–SC-009).
- [ ] T023 Executar a validação da feature conforme `quickstart.md`, registrar
