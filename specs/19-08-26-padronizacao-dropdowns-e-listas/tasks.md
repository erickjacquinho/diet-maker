...
- [ ] T001 [skill: frontend-architecture-mindset] [P] Create and export SelectOption types in src/components/atoms/select-field-types.ts
- [ ] T002 [skill: shadcn] [P] Verify and refine base Radix primitive wrappers in src/components/ui/select.tsx and src/components/ui/dropdown-menu.tsx
...
- [ ] T003 [skill: tdd] [P] Create unit tests for SelectField in tests/components/atoms/SelectField.test.tsx
- [ ] T004 [skill: shadcn] Implement standardized parent component SelectField in src/components/atoms/SelectField.tsx
- [ ] T005 [skill: frontend-architecture-mindset] Export SelectField in src/components/atoms/index.ts and src/components/molecules/index.ts
- [ ] T006 [skill: tdd] [P] Create unit tests for ActionDropdown in tests/components/molecules/ActionDropdown.test.tsx
- [ ] T007 [skill: shadcn] Implement standardized parent component ActionDropdown in src/components/molecules/ActionDropdown.tsx
- [ ] T008 [skill: frontend-architecture-mindset] Export ActionDropdown in src/components/molecules/index.ts
...
- [ ] T009 [skill: shadcn] [P] [US1] Migrate CreatePatientModal to use SelectField in src/components/molecules/CreatePatientModal.tsx
- [ ] T010 [skill: shadcn] [P] [US1] Migrate EditPatientModal to use SelectField in src/components/molecules/EditPatientModal.tsx
- [ ] T011 [skill: shadcn] [P] [US1] Migrate CreatePresetModal to use SelectField in src/components/molecules/CreatePresetModal.tsx
- [ ] T012 [skill: shadcn] [P] [US1] Migrate CustomFoodModal to use SelectField in src/components/molecules/CustomFoodModal.tsx
- [ ] T013 [skill: shadcn] [P] [US1] Migrate NextEventModal to use SelectField in src/components/molecules/NextEventModal.tsx
- [ ] T014 [skill: shadcn] [P] [US1] Migrate CopyVariationModal to use SelectField in src/components/molecules/CopyVariationModal.tsx
- [ ] T015 [skill: shadcn] [P] [US1] Migrate FoodFilterHeader to use SelectField in src/components/organisms/foods/FoodFilterHeader.tsx
- [ ] T016 [skill: tdd] [US1] Verify and run regression tests for all migrated modal and filter forms with npm test
...
- [ ] T017 [skill: shadcn] [US2] Migrate header action dropdown in DietBuilderTemplate to use ActionDropdown in src/components/templates/DietBuilderTemplate.tsx
- [ ] T018 [skill: tdd] [US2] Add integration test for DietBuilderTemplate action dropdown in tests/components/templates/DietBuilderTemplate.test.tsx
...
- [ ] T019 [skill: shadcn] [US3] Refactor category selection and remove inline search dropdown in CreateRecipeModal in src/components/molecules/CreateRecipeModal.tsx
- [ ] T020 [skill: ui-ux-pro-max] [US3] Update Design System Showcase component catalog and spec grid in src/app/design-system/components/sections/ComponentSpecGrid.tsx
- [ ] T021 [skill: code-reviewer-expert] [US3] Perform static audit across src/ to ensure zero hardcoded inline styles (style={{ ... }}) and zero ad-hoc list dropdowns exist
...
- [ ] T022 [skill: general] Run full project test suite and typecheck with npm test and npm run typecheck
- [ ] T023 [skill: general] Execute quickstart.md validation checklist in specs/19-08-26-padronizacao-dropdowns-e-listas/quickstart.md
