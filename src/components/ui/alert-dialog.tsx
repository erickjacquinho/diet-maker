...
>(({ className, layer = 'overlay', ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'fixed inset-0 bg-backdrop-overlay data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      layer === 'modal' ? 'z-modal' : 'z-overlay',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn(textStyle("dialog-title"), className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn(textStyle("body-secondary"), className)}
    {...props}
  />
))
...
>(({ className, variant = "secondary", size = "compact", ...props }, ref) => (
