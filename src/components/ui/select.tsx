  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        layer === "modal" ? "z-modal" : "z-dropdown",
        position === "popper" &&
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-control border border-transparent py-2 pl-2 pr-8 text-style-nav-item text-text-secondary outline-none transition-colors duration-fast ease-standard focus:bg-surface-hover focus:text-text-primary data-[state=checked]:border-transparent data-[state=checked]:bg-surface-subtle data-[state=checked]:text-primary data-[disabled]:pointer-events-none data-[disabled]:text-disabled data-[disabled]:opacity-disabled motion-reduce:transition-none",
      className
    )}
    {...props}
  >
