...
type SelectContentLayer = "popover" | "modal"
...
const SelectContent = React.forwardRef<
  ...
  SelectContentProps
>(({ className, children, layer = "popover", position = "popper", ...props }, ref) => (
