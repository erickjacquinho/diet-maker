...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-overlay bg-backdrop-overlay data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-overlay gap-4 bg-surface p-6 shadow-overlay transition duration-standard ease-standard data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
  {
    variants: {
      side: {
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse flex-row justify-end gap-2",
      className
    )}
    {...props}
  />
