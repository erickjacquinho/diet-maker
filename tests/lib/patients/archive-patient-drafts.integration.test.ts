...
const patient = { id: 'patient-a', accountId: 'account-a', displayCode: 'P-0001', name: 'Ana', age: 30, gender: 'F', birthDate: null, isPregnant: false, pregnancyDueDate: null, heightCm: 165, weightKg: 64, currentObjective: 'Manutenção', defaultMacroTargets: { proteinG: 120, carbsG: 180, fatsG: 55, kcal: 1655 }, createdAt: '', updatedAt: '', version: 2, archivedAt: '2026-08-30T12:00:00.000Z' };
