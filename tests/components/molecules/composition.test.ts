...
const molecules = ["AutoKcalSection", "MacroMetricCard", "MealItemRow", "PatientBadgeHeader", "RecipeCard", "RecipeIngredientRow", "SidebarBrand", "SidebarNavItem", "SidebarQuickActions", "SidebarUserProfile", "TacoSearchInput"];
