export const legacyRules = [
  ...
  { code: 'LEG005', rule: 'legacy-depth-motion', pattern: /\b(?:transition-all|hover:scale-[\w-]+|duration-(?!fast|standard|slow|hold|0)[\w-]+|shadow-(?!floating|overlay|none)[\w-]+)\b/g, message: 'Use motion autorizada (duration fast/standard/slow/hold), elevação floating/overlay e sem scale em hover.' },
