...
const NON_CATALOG_COMPONENT_SOURCES = new Set([
  ...
  'src/components/molecules/food-search/FoodSearchCategorySelector.tsx',
  'src/components/molecules/food-search/ReadyMealSearchResultsList.tsx',
  'src/components/molecules/food-search/RecipeSearchResultsList.tsx',
  ...
  'src/components/organisms/patient/PatientAssessmentsTable.tsx',
  'src/components/organisms/patient/PatientDietsTable.tsx',
