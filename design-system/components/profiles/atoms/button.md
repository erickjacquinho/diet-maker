...
| Public exports | `ButtonProps` (type), `Button` (component), `CreateButtonProps` (type), `CreateButton` (compound-part), `SecondaryActionButtonProps` (type), `SecondaryActionButton` (compound-part), `IconButtonProps` (type), `IconButton` (compound-part), `ExplicitIconButtonProps` (type), `EditIconButton` (compound-part), `DeleteIconButton` (compound-part) |
...
Root `Button` e exports visuais registrados: `Button`, `CreateButton`, `SecondaryActionButton`, `IconButton`, `EditIconButton`, `DeleteIconButton`. Base declarada: `ui-button`.
