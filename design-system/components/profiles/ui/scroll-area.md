...
| Current layer | `ui` |
| Target layer | `ui` |
| Sources | `src/components/ui/scroll-area.tsx` |
| Public exports | `ScrollArea` (component), `ScrollBar` (compound-part) |

## Purpose

Conter overflow preservando viewport e scrollbar acessíveis.
...
Root `ScrollArea` e exports visuais registrados: `ScrollArea`, `ScrollBar`. Sem primitive base; compõe somente dependências permitidas pela layer.
