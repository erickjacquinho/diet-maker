...
All colors, font scales, border-radii, spacing, and transition rules must be derived exclusively from the NutriDiet Design System specification at `design-system/nutridiet/MASTER.md` and its sub-modules. Zero custom box-shadows or gradients allowed.
